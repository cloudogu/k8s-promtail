...
helm-promtail-apply: ${BINARY_HELM} helm-generate $(K8S_POST_GENERATE_TARGETS) ## Generates and installs the helm chart.
...
helm-promtail-chart-import: ${BINARY_HELM} k8s-generate helm-generate-chart helm-package-release ## Pushes the helm chart to the k3ces registry.
